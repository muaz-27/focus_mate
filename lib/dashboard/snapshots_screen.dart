...
class _SnapshotsScreenState extends State<SnapshotsScreen> {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final validDocs = docs.where((d) {
            ...
            return base64 != null && !base64.startsWith('ERROR:') && base64.length > 100;
          }).toList();
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isDark ? Colors.indigo.withOpacity(0.15) : Colors.indigo.withOpacity(0.08),
  ...
  void _showFullscreen(BuildContext context, Uint8List? bytes, String dateStr) {
