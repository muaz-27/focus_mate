...
class ParentScheduleListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('$studentName\'s Schedules', style: const TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        backgroundColor: Colors.transparent,
        elevation: 0,
        leading: IconButton(
          ...
          SafeArea(
            child: schedulesAsync.when(
              ...
              data: (allSchedules) {
                ...
                final schedules = allSchedules.where((s) => s.companionId == parentId).toList();
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                             scheduleService.deleteSchedule(studentId, schedule.id);
                          },
                        ),
                      ),
                    );
